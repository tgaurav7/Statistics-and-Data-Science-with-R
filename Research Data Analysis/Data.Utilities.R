...
corrEstimates<- function(Data.df){
  #' corrEstimates
  #'
  ...
  cat("Computing correlation indicators.....", "\n" , "Covariance: ", cov(Data.df$Perc..of.TBIs, Data.df$Perc..of.Datas), "\n", "Correlation coefficient: ", cor(Data.df$Perc..of.TBIs, Data.df$Perc..of.Datas), "\n", "Correlation Test:", "\n")
  print(cor.test(Data.df$Perc..of.TBIs, Data.df$Perc..of.Datas))
}

# function to plot the model
plotModel <- function(Data.df, modelinput,  modeldata, num=2){
	#' plotModel
	#'
...
AnalyseModel<-function(model, Data.df, tolLevel=0.25){
	...
	hist(Data.df$Perc..of.TBIs)
	
	# histogram plot of Percent of Datas
	hist(Data.df$Perc..of.Datas)
	...
	par(mfrow =c(1 ,3))	
	plot(Data.df$Perc..of.TBIs ,model$res)
	plot(Data.df$Perc..of.Datas ,model$res)
	...
	par(mfrow =c(1 ,3))	
	plot(Data.df$Perc..of.TBIs ,model.rs)
	plot(Data.df$Perc..of.Datas ,model.rs)
